...
#Configurando Interup��es do timerA
#Habilitando interrup��o timerA
addi $t0, $0, 4
mtc0 $t0, $9  #Registrador 9 � o IER
#Configurando a rotina de interrup��o do timer A
la $t0, isr_timerA
mtc0 $t0, $2	#Reg2 � o da ISR do Timer A
#Configurando TimerA
#Clock de 1kHz, quero delay de 1seg, ent�o preciso contar at� 1000
addi $t0, $0, 100
sw $t0, 17($0) #Endere�o 17 � o TargetA
addi $t0, $0, 1
sw $t0, 16($0) #Clock sem divis�o (1kHz), ativa o timer. Endere�o 16 � a configura��o
...
idle:	#Loop com nop pra encerrar
add $0, $0, $0
j idle
...
#Se passou de 2000, não habilita timer denovo
addi $t0, $s0, -2000
bgtz $t0, stop_timer
